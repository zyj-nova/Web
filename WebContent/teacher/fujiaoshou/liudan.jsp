        ...
        <div class="pageArticle">
            ...
            <div class="teacher-detail">
                <div class="teacher-img">
                    <span class="t-img"><a><img src="/NEFUSE/resources/images/liudan.jpg" alt=""></a></span>
                    <div class="t-txt01">
                        <h4>刘丹</h4>
                        <span>副教授，软件工程教师</span>
                ...
                <div class="teacher-d01">
                    ...
                    <div class="teacher-info">
                        主持或参与科技部支撑计划项目、省自然科学基金项目、省科技攻关项目、哈尔滨科技局项目、中央高校基本可言业务C类项目等科研、教学项目20余项
                    </div>
                </div>
                <div class="teacher-d01">
                    <h3 class="teacher-title">研究领域</h3>
                    <div class="teacher-info">
                     	无线传感器网络相关技术、数据仓库，数据挖掘。
                    </div>
                </div>
                <div class="teacher-d01">
                    <h3 class="teacher-title">研究成果</h3>
                    <div class="teacher-info">
                        论著及编著：出版教材7部，发表论文10余篇，其中EI收录论文7篇。获黑龙江省科技进步三等奖1项，省级奖励2项。授权发明专利、实用新型专利、软件著作权10余项。
                        </div>
                </div>
            </div>
        </div>
