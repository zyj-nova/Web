        ...
        <div class="pageArticle">
            ...
            <div class="teacher-detail">
                <div class="teacher-img">
                    <span class="t-img"><a><img src="/NEFUSE/resources/images/luosiqing.png" alt=""></a></span>
                    <div class="t-txt01">
                        <h4>罗嗣卿</h4>
                        <span>硕士，副教授，硕士生导师，软件工程领域（工程硕士）负责人、软件工程专业主任。</span>
                ...
                <div class="teacher-d01">
                    ...
                    <div class="teacher-info">
                      	信息系统析与设计、图像处理、软件服务与应用
                    </div>
                </div>
                <div class="teacher-d01">
                    <h3 class="teacher-title">研究成果</h3>
                    <div class="teacher-info">
                        论著及编著：主持和参加省攻关重点、省自然基金、国家林业公益性行业专项、省教改项目15项，发表论文20余篇，教材3部。
                        </div>
                </div>
            </div>
        </div>
