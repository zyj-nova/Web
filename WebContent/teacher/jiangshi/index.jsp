...
<article class="subPage">
	...
	<div class="subPage_con">
		...
		<section class="sub_right marginBot">
			<div>
				<p
					style="padding: 0 10px 0 0; width: 180px; background-image: none; font-size: 1.8em; color: #005bac;">讲师</p>
			</div>
			<br> <br>
			<div class="subBanner01">
				<p style="font-size: 15px;">
					<span style="font-family: 微软雅黑;">东北林业大学软件工程讲师</span>
				</p>
			...
			<aside class="con_list01">
				<ul class="list_con01">
					<li><span><a href="./bo.jsp">王波</a></span></li>
