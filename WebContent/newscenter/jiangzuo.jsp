...
<body>
	...
	<article class="subPage">
		...
		<div class="subPage_con">
			<div class="bread">
				<span>您所在的位置： <a href="${pageContext.request.contextPath  }/index">首页</a>&raquo; <a
					href="${pageContext.request.contextPath  }/allnews">新闻中心 </a>&raquo; 学术讲座
				</span>
			</div>
				...
				<div class="pageArticle">
					<div class="article cur02">
						...
						<ul class="list01">
							...
							<c:forEach items="${jiangzuo }" var="it">
								<li><a href="news_detail?id=${ it.id}">${it.title }</a><span class="rightDate">${it.insertDate }</span></li>
